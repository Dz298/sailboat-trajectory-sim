...
washold = ishold;
hold on
hbox = patch(blon,blat,'w','DisplayName','box');
set( get( get( hbox, 'Annotation'), 'LegendInformation' ), 'IconDisplayStyle', 'off' );
set(hbox,'Tag','MapScale');
hline = plot(slon,slat,'k','LineWidth',3, 'DisplayName','line');
